...
public class CustomerB {
    public static void main(String[] args) throws IOException {
        ...
        try {
            CustomerBSocket = new Socket(ServerName, WarehouseSocketNumber);
            out = new PrintWriter(CustomerBSocket.getOutputStream(), true);
            in = new BufferedReader(new InputStreamReader(CustomerBSocket.getInputStream()));
